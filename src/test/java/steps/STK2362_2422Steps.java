...
public class STK2362_2422Steps extends CommonMethods {
    ...
    public void click_on_the_Learn_more_text() {
        ...
        Assert.assertEquals("Market Watch | AAVE | Stacked", driver.getTitle());
    }

    @Then("Click the See more link")
    public void click_the_See_more_link() {
        dashboardPage.seeMoreTab.click();
        Assert.assertEquals("Market Watch | Stacked", driver.getTitle());
    }
